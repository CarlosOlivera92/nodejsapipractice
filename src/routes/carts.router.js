...
export default class CartsRouter extends Router {
    ...
    init() {
        ...
        this.post("/", [accessRolesEnum.USER, accessRolesEnum.PREMIUM], passportStrategiesEnum.JWT, this.authorize(["USER", "PREMIUM"]), (req, res, next) => this.cartsController.createCart(req, res, next));
        ...
        this.post('/:cid/purchase', [accessRolesEnum.USER, accessRolesEnum.PREMIUM], passportStrategiesEnum.JWT,this.authorize(["USER", "PREMIUM"]) ,(req, res, next) => this.ticketController.purchase(req, res, next));
    }
}
